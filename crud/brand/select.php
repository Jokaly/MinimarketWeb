...
<html lang="en">
    ...
    <body>
        ...
        <main>
                            ...
                            <div class="col-6">
                                <form class="d-flex" role="search">
                                    <div class="input-group">
                                        <input class="form-control" type="search" placeholder="Buscar marcas" aria-label="Search"/>
                                ...
                                <?php
                                    ...
                                    if ($stmt->rowCount() > 0) {
                                        ...
                                        foreach ($stmt as $row) {
                                            ...
                                            echo "<td class='d-flex justify-content-center'><img class='image-profile rounded' src='data:image/jpeg;base64," . base64_encode($row['logo']) . "' alt=''></td>";
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="updateModalLabel' . htmlspecialchars($row['id']) . '">Actualizar Marca</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="update.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <img class="image-product" src="data:image/jpeg;base64,' . base64_encode($row['logo']) . '" alt="">
                                        ...
                                        echo "<tr><td colspan='5' class='text-center'>No hay marcas disponibles</td></tr>";
                                    }
                                ?>
                            </tbody>
                        </table>
            ...
            <!-- Modal para Insertar Marca -->
            <div class="modal fade" id="insertModal" tabindex="-1" aria-labelledby="insertModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="insertModalLabel">Agregar Nueva Marca</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
